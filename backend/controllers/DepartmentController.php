...
class DepartmentController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','AjaxGetByLibrary'),
				'users'=>array('admin'),
			),
    ...
    */
	public function actionAjaxGetByLibrary()
	{
		$data=Department::model()->findAll('library_id=:library',
			array(':library'=>(int) $_POST['library']));
		$emptyOption = isset($_POST['empty']) ? $_POST['empty']: false;
		$data=CHtml::listData($data,'id','name');
		if ($emptyOption)
			echo CHtml::tag('option',
				array('value'=>null),CHtml::encode(''),true);
